import { flattenHeaders, parseHeaders, processHeaders } from '@/helpers/headers';
...
describe('helpers:headers', () => {
  ...
  describe('processHeaders', () => {
    ...
    it('should do nothing if headers is undefined or null', () => {
      expect(processHeaders(void 0, {})).toBeUndefined();
  ...
  describe('flattenHeaders', () => {
    ...
    it('should do nothing if headers is undefined or null', () => {
      expect(flattenHeaders(void 0, 'get')).toBeUndefined();
